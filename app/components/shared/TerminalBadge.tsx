...
export function TerminalBadge({ children, variant = "default", className = "" }: TerminalBadgeProps) {
  ...
  return (
    <span
      className={`inline-flex items-center bg-[rgba(225,253,255,0.1)] border border-[rgba(225,253,255,0.2)] px-[9px] py-[5px] rounded-[2px] text-[#e1fdff] text-[14px] tracking-[0.28px] ${className}`}
      style={{ fontFamily: "'JetBrains Mono', monospace", fontWeight: 500 }}
    >
      {children}
    </span>
